...
<head>
    ...
    <link rel="stylesheet" href="{{asset('libs/datetimepicker/DateTimePicker.css')}}" type="text/css">
    <!-- Styles -->
    <style>
...
<body class="antialiased">
    ...
    <div class="admin-wrapper" id="wrapper">
        @section('sidebar')
        <div class="left-sidebar">
            <h3>MAIN MENU</h3>
            <ul>
                <li><a href="{{ route('brand.index')}}">Hãng xe</a></li>
    ...
    <div class="show-popup__loading"></div>
</body>
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.1/jquery.min.js" integrity="sha512-aVKKRRi/Q/YV+4mjoKBsE4x3H+BkegoM/em46NNlCqNTmUYADjBbeNefNxYV7giUp0VxICtqdrbqU7iVaeZNXA==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
<script src="{{asset('libs/datetimepicker/DateTimePicker.min.js')}}"></script>
...
<script>
    ...
    $('form textarea').click(function(e) {
        e.preventDefault();
    });
</script>
@yield('admin-scripts')
